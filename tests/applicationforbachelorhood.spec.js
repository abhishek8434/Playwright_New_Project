...
test.describe('Apply For Citizenship', () => {
    ...
    test('TC 3: all mandatory field ', async () => {
        ...
        await page.locator('li').filter({ hasText: 'Upload Identity Card Issued' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        ...
        await page.locator('li').filter({ hasText: '* Upload passport photo of Husband Upload Upload Cancel' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload passport photo of Wife Upload Upload Cancel' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Affidavit of non-' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Birth Certificate or' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Certificate of State' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Notarized letter' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Nigerian' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Spouse means of' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Notarized consent' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Couples full length' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Full length photo of' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Marriage document of' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.locator('li').filter({ hasText: '* Upload Proof of Address eg' }).getByRole('textbox').setInputFiles('Get_Started_With_Smallpdf-output.pdf');
        await page.type(citizenshipbachelorhood.necessaryDocumentName, 'Test');
        await page.setInputFiles(citizenshipbachelorhood.necessaryDocument, 'Get_Started_With_Smallpdf-output.pdf');
